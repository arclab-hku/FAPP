...
namespace fapp_planner
{
  ...
  private:
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, trigger_sub_, broadcast_ploytraj_sub_, mandatory_stop_sub_, obj_sub_;
    ...
    bool planHovering(const Eigen::Vector3d hover_pt);
    ...
    void objectCallback(const obj_state_msgs::ObjectsStatesConstPtr &msg);
